...
const darkStyles = StyleSheet.create({
  ...
  headerButtons: { flexDirection: 'row', alignItems: 'center' },
  sortButton: { flexDirection: 'row', alignItems: 'center', marginRight: 12, paddingHorizontal: 8, paddingVertical: 4, borderRadius: 16, backgroundColor: '#474747' },
  sortButtonText: { fontSize: 12, color: '#fff', marginLeft: 4 },
  newPostButton: { backgroundColor: '#474747', paddingHorizontal: 12, paddingVertical: 6, borderRadius: 20 },
  newPostButtonText: { color: '#fff', fontWeight: 'bold' },
  ...
  categoryScrollContainer: { paddingLeft: 4, paddingRight: 4 },
  categoryButton: { paddingHorizontal: 16, paddingVertical: 8, marginHorizontal: 4, borderRadius: 20, backgroundColor: '#474747', minWidth: 80, alignItems: 'center' },
  selectedCategoryButton: { backgroundColor: '#2f2e2e' },
