...
const lightStyles = StyleSheet.create({
  ...
  header: { padding: 16, borderBottomWidth: 1, borderBottomColor: '#e1e4e8', backgroundColor: '#fff' },
  title: { fontSize: 20, fontWeight: 'bold', color: Colors.primary },
  settingsContainer: { flex: 1 },
  section: { marginBottom: 24, backgroundColor: '#fff', borderTopWidth: 1, borderBottomWidth: 1, borderColor: '#e1e4e8' },
  sectionTitle: { fontSize: 16, fontWeight: '600', paddingHorizontal: 16, paddingVertical: 12, backgroundColor: '#f8f9fa', color: '#666' },
  setting: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', padding: 16, borderBottomWidth: 1, borderBottomColor: '#f1f1f1' },
  settingHeader: { flexDirection: 'row', alignItems: 'center' },
  settingTitle: { fontSize: 16, marginLeft: 12, color: '#333' },
  sliderContainer: { flex: 1, marginTop: 8, paddingHorizontal: 24 },
  slider: { width: '100%', height: 40 },
  sliderLabels: { marginTop: 8 },
  sliderValue: { fontSize: 16, fontWeight: '500', textAlign: 'center', color: Colors.primary },
  sliderMinMax: { flexDirection: 'row', justifyContent: 'space-between', marginTop: 4 },
  sliderMinMaxText: { fontSize: 12, color: '#888' },
  footer: { padding: 16, borderTopWidth: 1, borderTopColor: '#e1e4e8', backgroundColor: '#fff' },
...
const darkStyles = StyleSheet.create({
  ...
  header: { padding: 16, borderBottomWidth: 1, borderBottomColor: '#121212', backgroundColor: '#2f2e2e' },
  title: { fontSize: 20, fontWeight: 'bold', color: Colors.primary },
  settingsContainer: { flex: 1 },
  section: { marginBottom: 24, backgroundColor: '#1E1E1E', borderTopWidth: 1, borderBottomWidth: 1, borderColor: '#2f2e2e' },
  sectionTitle: { fontSize: 16, fontWeight: '600', paddingHorizontal: 16, paddingVertical: 12, backgroundColor: '#292929', color: '#666' },
  setting: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', padding: 16, borderBottomWidth: 1, borderBottomColor: '#121212' },
  settingHeader: { flexDirection: 'row', alignItems: 'center' },
  settingTitle: { fontSize: 16, marginLeft: 12, color: '#fff' },
  sliderContainer: { flex: 1, marginTop: 8, paddingHorizontal: 24 },
  slider: { width: '100%', height: 40 },
  sliderLabels: { marginTop: 8 },
  sliderValue: { fontSize: 16, fontWeight: '500', textAlign: 'center', color: Colors.primary },
  sliderMinMax: { flexDirection: 'row', justifyContent: 'space-between', marginTop: 4 },
  sliderMinMaxText: { fontSize: 12, color: '#fff' },
  footer: { padding: 16, borderTopWidth: 1, borderTopColor: '#e1e4e8', backgroundColor: '#1E1E1E' },
  saveButton: { backgroundColor: Colors.primary, paddingVertical: 12, borderRadius: 8, alignItems: 'center' },
  saveButtonText: { color: '#fff', fontSize: 16, fontWeight: 'bold' },
});
